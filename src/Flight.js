    ...
    return (
        <div className = 'record'>
            ...
            <div>
                ...
                <input type = 'text' className = 'textbox' style = {{border: 'none', backgroundColor: 'rgb(245, 246, 250)', width: '300px', color: 'rgb(139,34,34)'}} value={errors.flightdate} readOnly/>
            </div>
            ...
            <div className={big ? 'big' : 'small'}>
                ...
                <div>    
                    ...
                    <input type = 'text' className = 'textbox' style = {{border: 'none', backgroundColor: 'rgb(245, 246, 250)', width: '450px', color: 'rgb(139,34,34)'}} value={errors.callsign} readOnly/>
                </div>
                ...
                <div>    
                    ...
                    <input type = 'text' className = 'textbox' style = {{border: 'none', backgroundColor: 'rgb(245, 246, 250)'}} value={errors.airfield} readOnly/>
                </div>
